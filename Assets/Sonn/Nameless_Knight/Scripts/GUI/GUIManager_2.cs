...
{
    public class GUIManager_2 : MonoBehaviour, IComponentChecking
    {
        public Image bgEndgame, menuEndgame, iconCounter;
        ...
        private void NonActiveObject()
        {
            ...
            btnLevel_1.gameObject.SetActive(false);
        }
        ...
        public void BackGameEvent()
        {
            if (IsComponentNull())
            {
                return;
            }
            btnLevel_1.gameObject.SetActive(true);
            btnMenu.gameObject.SetActive(true);
            btnReplay.gameObject.SetActive(false);
            iconCounter.gameObject.SetActive(false);
            countTxt.gameObject.SetActive(false);
            btnBack.gameObject.SetActive(false);
        }  
        public void BackToLevel_1()
        {
            if (IsComponentNull())
            {
                return;
